...
/**
 * The persistent class for the g01_news database table.
 * 
 */
@Entity
@Table(name="g01_news")
@NamedQuery(name="G01News.findAll", query="SELECT g FROM G01News g")
public class G01News implements Serializable {
