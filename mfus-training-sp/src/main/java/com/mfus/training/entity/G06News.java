...
/**
 * The persistent class for the g06_news database table.
 * 
 */
@Entity
@Table(name="g06_news")
@NamedQuery(name="G06News.findAll", query="SELECT g FROM G06News g")
public class G06News implements Serializable {
