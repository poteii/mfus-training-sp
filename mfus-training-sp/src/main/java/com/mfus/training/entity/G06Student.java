...
/**
 * The persistent class for the g06_student database table.
 * 
 */
@Entity
@Table(name="g06_student")
@NamedQuery(name="G06Student.findAll", query="SELECT g FROM G06Student g")
public class G06Student implements Serializable {
