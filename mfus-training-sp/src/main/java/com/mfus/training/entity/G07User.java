...
/**
 * The persistent class for the g07_user database table.
 * 
 */
@Entity
@Table(name="g07_user")
@NamedQuery(name="G07User.findAll", query="SELECT g FROM G07User g")
public class G07User implements Serializable {
