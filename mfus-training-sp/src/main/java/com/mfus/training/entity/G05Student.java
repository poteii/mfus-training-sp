...
/**
 * The persistent class for the g05_student database table.
 * 
 */
@Entity
@Table(name="g05_student")
@NamedQuery(name="G05Student.findAll", query="SELECT g FROM G05Student g")
public class G05Student implements Serializable {
