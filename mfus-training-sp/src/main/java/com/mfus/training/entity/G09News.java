...
/**
 * The persistent class for the g09_news database table.
 * 
 */
@Entity
@Table(name="g09_news")
@NamedQuery(name="G09News.findAll", query="SELECT g FROM G09News g")
public class G09News implements Serializable {
