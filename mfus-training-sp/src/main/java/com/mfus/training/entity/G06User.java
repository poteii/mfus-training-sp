...
/**
 * The persistent class for the g06_user database table.
 * 
 */
@Entity
@Table(name="g06_user")
@NamedQuery(name="G06User.findAll", query="SELECT g FROM G06User g")
public class G06User implements Serializable {
