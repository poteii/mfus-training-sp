...
/**
 * The persistent class for the g07_student database table.
 * 
 */
@Entity
@Table(name="g07_student")
@NamedQuery(name="G07Student.findAll", query="SELECT g FROM G07Student g")
public class G07Student implements Serializable {
