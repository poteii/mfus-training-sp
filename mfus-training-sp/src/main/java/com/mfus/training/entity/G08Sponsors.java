...
/**
 * The persistent class for the g08_sponsors database table.
 * 
 */
@Entity
@Table(name="g08_sponsors")
@NamedQuery(name="G08Sponsors.findAll", query="SELECT g FROM G08Sponsors g")
public class G08Sponsors implements Serializable {
