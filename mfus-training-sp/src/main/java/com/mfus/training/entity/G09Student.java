...
/**
 * The persistent class for the g09_student database table.
 * 
 */
@Entity
@Table(name="g09_student")
@NamedQuery(name="G09Student.findAll", query="SELECT g FROM G09Student g")
public class G09Student implements Serializable {
