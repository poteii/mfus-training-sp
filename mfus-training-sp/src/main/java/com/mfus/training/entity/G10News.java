...
/**
 * The persistent class for the g10_news database table.
 * 
 */
@Entity
@Table(name="g10_news")
@NamedQuery(name="G10News.findAll", query="SELECT g FROM G10News g")
public class G10News implements Serializable {
