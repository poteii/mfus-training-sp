...
/**
 * The persistent class for the g05_news database table.
 * 
 */
@Entity
@Table(name="g05_news")
@NamedQuery(name="G05News.findAll", query="SELECT g FROM G05News g")
public class G05News implements Serializable {
