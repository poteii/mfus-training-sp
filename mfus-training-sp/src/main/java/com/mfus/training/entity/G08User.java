...
/**
 * The persistent class for the g08_user database table.
 * 
 */
@Entity
@Table(name="g08_user")
@NamedQuery(name="G08User.findAll", query="SELECT g FROM G08User g")
public class G08User implements Serializable {
