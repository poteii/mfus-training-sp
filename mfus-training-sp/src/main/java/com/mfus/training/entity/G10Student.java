...
/**
 * The persistent class for the g10_student database table.
 * 
 */
@Entity
@Table(name="g10_student")
@NamedQuery(name="G10Student.findAll", query="SELECT g FROM G10Student g")
public class G10Student implements Serializable {
