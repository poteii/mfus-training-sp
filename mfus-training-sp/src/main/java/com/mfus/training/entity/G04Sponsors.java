...
/**
 * The persistent class for the g04_sponsors database table.
 * 
 */
@Entity
@Table(name="g04_sponsors")
@NamedQuery(name="G04Sponsors.findAll", query="SELECT g FROM G04Sponsors g")
public class G04Sponsors implements Serializable {
