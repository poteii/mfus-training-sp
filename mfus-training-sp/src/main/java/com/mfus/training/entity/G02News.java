...
/**
 * The persistent class for the g02_news database table.
 * 
 */
@Entity
@Table(name="g02_news")
@NamedQuery(name="G02News.findAll", query="SELECT g FROM G02News g")
public class G02News implements Serializable {
