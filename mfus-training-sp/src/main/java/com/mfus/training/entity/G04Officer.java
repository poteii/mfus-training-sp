...
/**
 * The persistent class for the g04_officer database table.
 * 
 */
@Entity
@Table(name="g04_officer")
@NamedQuery(name="G04Officer.findAll", query="SELECT g FROM G04Officer g")
public class G04Officer implements Serializable {
