...
/**
 * The persistent class for the g02_officer database table.
 * 
 */
@Entity
@Table(name="g02_officer")
@NamedQuery(name="G02Officer.findAll", query="SELECT g FROM G02Officer g")
public class G02Officer implements Serializable {
