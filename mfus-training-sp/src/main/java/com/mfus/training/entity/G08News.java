...
/**
 * The persistent class for the g08_news database table.
 * 
 */
@Entity
@Table(name="g08_news")
@NamedQuery(name="G08News.findAll", query="SELECT g FROM G08News g")
public class G08News implements Serializable {
