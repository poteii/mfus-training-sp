...
/**
 * The persistent class for the g10_user database table.
 * 
 */
@Entity
@Table(name="g10_user")
@NamedQuery(name="G10User.findAll", query="SELECT g FROM G10User g")
public class G10User implements Serializable {
