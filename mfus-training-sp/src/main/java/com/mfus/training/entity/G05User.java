...
/**
 * The persistent class for the g05_user database table.
 * 
 */
@Entity
@Table(name="g05_user")
@NamedQuery(name="G05User.findAll", query="SELECT g FROM G05User g")
public class G05User implements Serializable {
