...
/**
 * The persistent class for the g00_student database table.
 * 
 */
@Entity
@Table(name="g00_student")
@NamedQuery(name="G00Student.findAll", query="SELECT g FROM G00Student g")
public class G00Student implements Serializable {
