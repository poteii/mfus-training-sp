...
/**
 * The persistent class for the g04_news database table.
 * 
 */
@Entity
@Table(name="g04_news")
@NamedQuery(name="G04News.findAll", query="SELECT g FROM G04News g")
public class G04News implements Serializable {
