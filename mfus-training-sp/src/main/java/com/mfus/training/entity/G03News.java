...
/**
 * The persistent class for the g03_news database table.
 * 
 */
@Entity
@Table(name="g03_news")
@NamedQuery(name="G03News.findAll", query="SELECT g FROM G03News g")
public class G03News implements Serializable {
