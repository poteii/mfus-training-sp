...
/**
 * The persistent class for the g10_officer database table.
 * 
 */
@Entity
@Table(name="g10_officer")
@NamedQuery(name="G10Officer.findAll", query="SELECT g FROM G10Officer g")
public class G10Officer implements Serializable {
