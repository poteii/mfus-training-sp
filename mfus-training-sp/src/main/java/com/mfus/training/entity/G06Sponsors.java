...
/**
 * The persistent class for the g06_sponsors database table.
 * 
 */
@Entity
@Table(name="g06_sponsors")
@NamedQuery(name="G06Sponsors.findAll", query="SELECT g FROM G06Sponsors g")
public class G06Sponsors implements Serializable {
