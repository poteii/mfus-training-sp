...
/**
 * The persistent class for the g10_sponsors database table.
 * 
 */
@Entity
@Table(name="g10_sponsors")
@NamedQuery(name="G10Sponsors.findAll", query="SELECT g FROM G10Sponsors g")
public class G10Sponsors implements Serializable {
