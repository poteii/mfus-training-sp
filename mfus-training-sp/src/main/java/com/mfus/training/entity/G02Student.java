...
/**
 * The persistent class for the g02_student database table.
 * 
 */
@Entity
@Table(name="g02_student")
@NamedQuery(name="G02Student.findAll", query="SELECT g FROM G02Student g")
public class G02Student implements Serializable {
