...
/**
 * The persistent class for the g02_user database table.
 * 
 */
@Entity
@Table(name="g02_user")
@NamedQuery(name="G02User.findAll", query="SELECT g FROM G02User g")
public class G02User implements Serializable {
