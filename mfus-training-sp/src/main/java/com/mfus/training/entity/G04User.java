...
/**
 * The persistent class for the g04_user database table.
 * 
 */
@Entity
@Table(name="g04_user")
@NamedQuery(name="G04User.findAll", query="SELECT g FROM G04User g")
public class G04User implements Serializable {
