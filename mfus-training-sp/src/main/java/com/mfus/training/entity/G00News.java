...
/**
 * The persistent class for the g00_news database table.
 * 
 */
@Entity
@Table(name="g00_news")
@NamedQuery(name="G00News.findAll", query="SELECT g FROM G00News g")
public class G00News implements Serializable {
