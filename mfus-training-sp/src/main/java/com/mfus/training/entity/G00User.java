...
/**
 * The persistent class for the g00_user database table.
 * 
 */
@Entity
@Table(name="g00_user")
@NamedQuery(name="G00User.findAll", query="SELECT g FROM G00User g")
public class G00User implements Serializable {
