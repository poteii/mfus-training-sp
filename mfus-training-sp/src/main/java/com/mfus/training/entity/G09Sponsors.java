...
/**
 * The persistent class for the g09_sponsors database table.
 * 
 */
@Entity
@Table(name="g09_sponsors")
@NamedQuery(name="G09Sponsors.findAll", query="SELECT g FROM G09Sponsors g")
public class G09Sponsors implements Serializable {
