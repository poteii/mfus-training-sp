...
/**
 * The persistent class for the g08_student database table.
 * 
 */
@Entity
@Table(name="g08_student")
@NamedQuery(name="G08Student.findAll", query="SELECT g FROM G08Student g")
public class G08Student implements Serializable {
