...
/**
 * The persistent class for the g07_officer database table.
 * 
 */
@Entity
@Table(name="g07_officer")
@NamedQuery(name="G07Officer.findAll", query="SELECT g FROM G07Officer g")
public class G07Officer implements Serializable {
